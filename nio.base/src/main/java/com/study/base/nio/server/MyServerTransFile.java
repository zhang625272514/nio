 ...
 * 使用Socket通信传输文件
 * 客户端向服务器端发送一个文件，服务器作为响应给客户端会发一个文件
 */
public class MyServerTransFile {

    private final static Logger logger = LoggerFactory.getLogger(MyServerTransFile.class.getName());
